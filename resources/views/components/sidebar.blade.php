  ...
  <div class="sidebar">
    ...
    <div class="list-group mt-5">
      <a href="/admin/dashboard"
        class="list-item text-white border-0 py-3 px-3 text-decoration-none d-flex align-items-center text-white w-100 mb-2"
        style="background: rgba(255, 255, 255, 0.15); border-radius: 10px; backdrop-filter: blur(20px); "><iconify-icon
          icon="radix-icons:dashboard" width="24"></iconify-icon>
        &nbsp;&nbsp;
        Dashboard</a>
      <a href="/admin/news"
        class="list-item text-white border-0 py-3 px-3 text-decoration-none d-flex align-items-center text-white w-100 mb-2"
