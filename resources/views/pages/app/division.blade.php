...
<section>
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-md-6 mb-4 text-white position-relative">
      <div class="px-2 py-4 text-center " style="background: rgba(255, 255, 255, 0.13); border-radius: 20px; backdrop-filter: blur(5px);">
        <div class="dropdown position-absolute dropstart" style="right: 20px;">
          ...
          <ul class="dropdown-menu" style="z-index: 999;">
            <li><a class="dropdown-item" href="{{ route('admin.division.edit', $item->id) }}"><iconify-icon icon="bx:edit"></iconify-icon>
                Edit</a></li>
            <li>
        ...
        <div class="d-flex justify-content-center mb-4">
          <div class="d-flex justify-content-center align-items-center" style="width: 88px; height: 88px; background: rgba(255, 255, 255, 0.19); border-radius: 20px;">
            <div>
...
=======
    <div class="row">
      @foreach ($data as $item)
        ...
        <p class="fw-light">{{ $item->description }}</p>
        <div class="mt-4">
          <a href="{{ route('admin.division.member') }}" class="text-decoration-none text-white fw-light px-4 py-2 border-1 border-white border rounded-pill">View
            More</a>
        </div>
      </div>
    </div>
